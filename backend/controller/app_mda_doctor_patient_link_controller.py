...
@router.get("/get-by-guid/{guid}", response_model=DoctorPatientLinkResponse)
...
@router.post("/create", response_model=DoctorPatientLinkResponse, status_code=201)
...
@router.put("/update/{guid}", response_model=DoctorPatientLinkResponse)
