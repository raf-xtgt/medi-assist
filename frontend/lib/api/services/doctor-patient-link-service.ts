...
import type { DoctorPatientLinkCreate, DoctorPatientLinkUpdate, DoctorPatientLinkResponse } from "../model/doctor-patient-link.model";

export type { DoctorPatientLinkCreate, DoctorPatientLinkUpdate, DoctorPatientLinkResponse };
